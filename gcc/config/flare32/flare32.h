/* Target Definitions for flare32.
...
#define FLARE32_FLAGS 18
/*
#define FLARE32_HI 19
#define FLARE32_LO 20
*/
/*
#define FLARE32_IDS 21
#define FLARE32_IRA 22
#define FLARE32_IE 23
#define FLARE32_ITY 23
#define FLARE32_STY 24
#define FLARE32_PC 25
*/
#define FLARE32_PC 19

#define FLARE32_FIRST_ARG_REGNUM \
  (FLARE32_R0)
#define FLARE32_LAST_ARG_REGNUM \
  (FLARE32_R5) \
  /* (FLARE32_R3) */
#define FLARE32_NUM_ARG_REGS \
  (FLARE32_LAST_ARG_REGNUM - FLARE32_FIRST_ARG_REGNUM + 1)

#define FLARE32_FIRST_GENERAL_REGNUM \
  (FLARE32_R0)
#define FLARE32_LAST_GENERAL_REGNUM \
  (FLARE32_FAKE_AP)
#define FLARE32_NUM_GENERAL_REGS \
  (FLARE32_LAST_GENERAL_REGNUM - FLARE32_FIRST_GENERAL_REGNUM + 1)
#define STATIC_CHAIN_REGNUM \
  (FLARE32_LAST_ARG_REGNUM + 1)

/*
#define FLARE32_FIRST_INTERRUPT_REG
  FLARE32_IDS
#define FLARE32_LAST_INTERRUPT_REG
  FLARE32_STY
#define FLARE32_NUM_INTERRUPT_REGS
  (FLARE32_LAST_INTERRUPT_REG - FLARE32_FIRST_INTERRUPT_REG + 1)
*/
...
#define REG_CLASS_CONTENTS \
  { \
    {0x0}, /* NO_REGS */ \
    {((1 << FLARE32_NUM_GENERAL_REGS) - 1) \
      << FLARE32_FIRST_GENERAL_REGNUM}, /* GENERAL_REGS */ \
    /*{0x3ffff},*/ /* GENERAL_REGS */ \
    {(1 << FLARE32_R0) | (1 << FLARE32_R1)}, \
      /* FULL_PRODUCT_RESULT_REGS */ \
    {1 << FLARE32_R0}, /* FULL_PRODUCT_HIGH_PART_REGS */ \
    {1 << FLARE32_R1}, /* FULL_PRODUCT_LOW_PART_REGS */ \
    {1 << FLARE32_FP}, /* FP_REGS */ \
    {1 << FLARE32_SP}, /* SP_REGS */ \
    {1 << FLARE32_FLAGS}, /* CC_REGS */ \
    {1 << FLARE32_PC}, /* PC_REGS */ \
    {1 << FLARE32_PC}, /* SPECIAL_REGS */ \
...
flare32_regno_to_class[FIRST_PSEUDO_REGISTER] =
{
  // r0, r1, r2, r3
  FULL_PRODUCT_HIGH_PART_REGS, FULL_PRODUCT_LOW_PART_REGS,
...
#define REGNO_REG_CLASS(R) \
  ((R < FIRST_PSEUDO_REGISTER) ? flare32_regno_to_class[R] : SPECIAL_REGS)
...
//#define STACK_POINTER_OFFSET (flare32_stack_pointer_offset ())
...
//#define FIRST_PARM_OFFSET(funcdel) (flare32_first_parm_offset (funcdecl))
...
//#define DWARF_FRAME_RETURN_COLUMN FLARE32_LR
#define DWARF_FRAME_RETURN_COLUMN DWARF_FRAME_REGNUM (FLARE32_LR)

#define RETURN_ADDR_RTX(C, F) flare32_get_return_address (C)
...
//#define INCOMING_FRAME_SP_OFFSET (flare32_incoming_frame_sp_offset ())
...
#define FUNCTION_ARG_REGNO_P(r) \
  (r >= FLARE32_FIRST_ARG_REGNUM && r <= FLARE32_LAST_ARG_REGNUM)
...
#endif
//#define REGNO_OK_FOR_INDEX_P(NUM) FLARE32_FP
...
#define TRAMPOLINE_DATA_ALIGNMENT 16
...
#define FLARE32_EXPAND_ALIGNMENT(COND, EXP, ALIGN) \
  ( \
    ( \
...
#define DATA_ALIGNMENT(EXP, ALIGN)   \
  (FLARE32_EXPAND_ALIGNMENT (!optimize_size, EXP, ALIGN))

// Always align objects on the stack
#define LOCAL_ALIGNMENT(EXP, ALIGN) \
  (FLARE32_EXPAND_ALIGNMENT (true, EXP, ALIGN))
