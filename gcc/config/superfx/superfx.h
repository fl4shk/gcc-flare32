/* Target Definitions for superfx.
...
#ifndef GCC_SUPERFX_H
#define GCC_SUPERFX_H
...
#define SUPERFX_R8 7
#define SUPERFX_R9 8
#define SUPERFX_R10 9
#define SUPERFX_R11 10
#define SUPERFX_R12 11
#define SUPERFX_LR 12
#define SUPERFX_FP 13
#define SUPERFX_SP 14
#define SUPERFX_FAKE_FP 15
#define SUPERFX_FAKE_AP 16
//#define SUPERFX_FAKE_FLAGS 17
/*
#define SUPERFX_HI 19
#define SUPERFX_LO 20
*/
/*
#define SUPERFX_IDS 21
#define SUPERFX_IRA 22
#define SUPERFX_IE 23
#define SUPERFX_ITY 23
#define SUPERFX_STY 24
#define SUPERFX_PC 25
*/
//#define SUPERFX_PC 18
#define SUPERFX_PC 17

#define SUPERFX_FIRST_ARG_REGNUM \
  (SUPERFX_R1)
#define SUPERFX_LAST_ARG_REGNUM \
  (SUPERFX_R6) \
  /* (SUPERFX_R3) */
#define SUPERFX_NUM_ARG_REGS \
  (SUPERFX_LAST_ARG_REGNUM - SUPERFX_FIRST_ARG_REGNUM + 1)

#define SUPERFX_FIRST_GENERAL_REGNUM \
  (SUPERFX_R1)
#define SUPERFX_LAST_GENERAL_REGNUM \
  (SUPERFX_FAKE_AP)
#define SUPERFX_NUM_GENERAL_REGS \
  (SUPERFX_LAST_GENERAL_REGNUM - SUPERFX_FIRST_GENERAL_REGNUM + 1)
#define STATIC_CHAIN_REGNUM \
  (SUPERFX_LAST_ARG_REGNUM + 1)

/*
#define SUPERFX_FIRST_INTERRUPT_REG
  SUPERFX_IDS
#define SUPERFX_LAST_INTERRUPT_REG
  SUPERFX_STY
#define SUPERFX_NUM_INTERRUPT_REGS
  (SUPERFX_LAST_INTERRUPT_REG - SUPERFX_FIRST_INTERRUPT_REG + 1)
*/
...
#define REG_CLASS_CONTENTS \
  { \
    {0x0}, /* NO_REGS */ \
    {((1 << SUPERFX_NUM_GENERAL_REGS) - 1) \
      << SUPERFX_FIRST_GENERAL_REGNUM}, /* GENERAL_REGS */ \
    /*{0x3ffff},*/ /* GENERAL_REGS */ \
    /* {(1 << SUPERFX_R0) | (1 << SUPERFX_R1)}, */ \
      /* FULL_PRODUCT_RESULT_REGS */ \
    /* {1 << SUPERFX_R0}, */ /* FULL_PRODUCT_HIGH_PART_REGS */ \
    /* {1 << SUPERFX_R1}, */ /* FULL_PRODUCT_LOW_PART_REGS */ \
    {1 << SUPERFX_FP}, /* FP_REGS */ \
    {1 << SUPERFX_SP}, /* SP_REGS */ \
    /* {1 << SUPERFX_FAKE_FLAGS}, */ /* CC_REGS */ \
    {1 << SUPERFX_PC}, /* PC_REGS */ \
    {1 << SUPERFX_PC}, /* SPECIAL_REGS */ \
...
superfx_regno_to_class[FIRST_PSEUDO_REGISTER] =
{
  // r0, 
  //FULL_PRODUCT_HIGH_PART_REGS, 
  //r1, r2, r3
...
#define REGNO_REG_CLASS(R) \
  ((R < FIRST_PSEUDO_REGISTER) ? superfx_regno_to_class[R] : NO_REGS)

//#define IRA_HARD_REGNO_ADD_COST_MULTIPLIER(jegno)
//  ((regno) <= SUPERFX_LAST_ARG_REGNUM ? 0.0 : 0.65)


// Force GCC to accept that SUPERFX_LR is to be restored during the
// epilogue
#define EPILOGUE_USES(r) (r == SUPERFX_LR)
...
// For superfx, the first arg is passed in register 0 (aka r0).
#define INIT_CUMULATIVE_ARGS(CUM,FNTYPE,LIBNAME,FNDECL,N_NAMED_ARGS) \
  /* (CUM = SUPERFX_R0) */ \
  (CUM = SUPERFX_FIRST_ARG_REGNUM)
...
//#define STACK_POINTER_OFFSET (superfx_stack_pointer_offset ())
...
//#define FIRST_PARM_OFFSET(funcdel) (superfx_first_parm_offset (funcdecl))

#undef PREFERRED_DEBUGGING_TYPE
#define PREFERRED_DEBUGGING_TYPE NO_DEBUG

// Don't add this until adding in DWARF2 stuff
#define INCOMING_RETURN_ADDR_RTX gen_rtx_REG (Pmode, SUPERFX_LR)
//#define DWARF_FRAME_RETURN_COLUMN SUPERFX_LR
#define DWARF_FRAME_RETURN_COLUMN DWARF_FRAME_REGNUM (SUPERFX_LR)

#define RETURN_ADDR_RTX(C, F) superfx_get_return_address (C)
...
//#define INCOMING_FRAME_SP_OFFSET (superfx_incoming_frame_sp_offset ())
...
#define STACK_POINTER_REGNUM SUPERFX_SP

// The register number of the frame pointer register, which is used to
// access automatic variables in the stack frame.
#define FRAME_POINTER_REGNUM SUPERFX_FAKE_FP
//#define FRAME_POINTER_REGNUM SUPERFX_FP

// The register number of the arg pointer register, which is used to
// access the function's argument list.
#define ARG_POINTER_REGNUM SUPERFX_FAKE_AP
//#define ARG_POINTER_REGNUM SUPERFX_FP

#define HARD_FRAME_POINTER_REGNUM SUPERFX_FP
...
#define INITIAL_ELIMINATION_OFFSET(FROM, TO, OFFSET) \
  do \
  { \
    (OFFSET) = superfx_initial_elimination_offset ((FROM), (TO)); \
  } while (0)

// A C expression that is nonzero if REGNO is the number of a hard
// register in which function arguments are sometimes passed.
#define FUNCTION_ARG_REGNO_P(r) \
  (r >= SUPERFX_FIRST_ARG_REGNUM && r <= SUPERFX_LAST_ARG_REGNUM)
...
#endif
//#define REGNO_OK_FOR_INDEX_P(NUM) SUPERFX_FP
...
#define TARGET_CPU_CPP_BUILTINS() \
  { \
    builtin_define_std ("superfx"); \
    builtin_define_std ("SUPERFX"); \
    builtin_define ("__SUPERFX__"); \
  }
...
#define SUPERFX_EXPAND_ALIGNMENT(COND, EXP, ALIGN) \
  ( \
    ( \
...
#define DATA_ALIGNMENT(EXP, ALIGN)   \
  (SUPERFX_EXPAND_ALIGNMENT (!optimize_size, EXP, ALIGN))

// Always align objects on the stack
#define LOCAL_ALIGNMENT(EXP, ALIGN) \
  (SUPERFX_EXPAND_ALIGNMENT (true, EXP, ALIGN))
